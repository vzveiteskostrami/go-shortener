...
// ненужных. Поддержка протоколов HTTP, HTTPS и gRPC.
// Запуск в командной строке:
//
//	shortener [-gRPC] [-c|-config=<json config file name>] [-s] [-a=<[in host]:<in port>>] [-b=<[out host]:<out port>>] [-f=<Storage text file name>] [-d=<Database connect string>]
package main
